...
import com.ilife.iliferobot_cn.holder.DeviceViewHolder;
import com.ilife.iliferobot_cn.interface_.OnItemClickListener;
import com.ilife.iliferobot_cn.R;

/**
 * Created by chenjiaping on 2017/8/31.
 */
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    DeviceViewHolder viewHolder = (DeviceViewHolder) getChildViewHolder(view);
