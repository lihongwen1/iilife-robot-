...
public class MapActivity_X7_ extends BaseActivity implements View.OnClickListener {
    final String TAG = MapActivity_X7_.class.getSimpleName();
    ...
    public static final String KEY_CUR_STATUS = "curStatus";
    ...
    int mopForce;
    byte sendByte;
    boolean isWork, hasAppoint, isMaxMode, hasStart, registerTag, hasStart_, voiceOpen;
...
//        }).start();
    ...
    public void setStatus(int curStatus, int batteryNo, int mopForce, boolean isMaxMode, boolean voiceOpen) {
        ...
        if (batteryNo != -1) {
            ...
            SpUtils.saveInt(context, physicalId + KEY_CUR_STATUS, curStatus);
        }
        clearAll(curStatus);
        if (curStatus == 0x8) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.image_setting:
                Intent i = new Intent(context, SettingActivity_x7.class);
                startActivity(i);
                break;
