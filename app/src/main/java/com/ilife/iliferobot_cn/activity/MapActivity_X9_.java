...
public class MapActivity_X9_ extends BackBaseActivity<MapX9Presenter> implements MapX9Contract.View {
    ...
    private int USE_MODE = USE_MODE_NORMAL;
    ...
    public void initView() {
        ...
        switch (mPresenter.getRobotType()) {
            case "X900":
                rechargeModel = R.drawable.rechage_device_x900;
                break;
            case "X800":
    ...
    public void updateStartStatue(boolean isSelect, String value) {
        boolean isX9 = mPresenter.getRobotType().equals("X900");
        if (isSelect) {
            if (isX9) {
